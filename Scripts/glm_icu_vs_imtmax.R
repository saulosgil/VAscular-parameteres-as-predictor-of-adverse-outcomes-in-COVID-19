...
model1 <- parameters::model_parameters(glm(formula =  icu_admission_0_no_1_yes ~ im_tmax_med +
...
odds <- round(exp(coef(object = glm(formula =  icu_admission_0_no_1_yes ~ im_tmax_med +
                                      x1_man_2_women +
                                      sat_o2_percent +
                                      obesity +
                                      smoking +
...
ic <- round(exp(confint(object = glm(formula =  icu_admission_0_no_1_yes ~ im_tmax_med +
                                       x1_man_2_women +
                                       sat_o2_percent +
                                       obesity +
                                       smoking +
